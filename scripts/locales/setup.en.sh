...
MSG_EXISTING_INSTALLATION="Existing installation detected at %s; configuration and data will be preserved."
...
MSG_MYSQL_CONFIG_REUSE="Using the database configuration from the existing installation."
